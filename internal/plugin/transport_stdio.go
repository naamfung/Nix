...
func prepareMCPPrivateStateForOS(s Spec, processSandbox sandbox.Spec, env []string, goos string) (sandbox.Spec, []string, error) {
	...
	// short temporary directory. Nesting TEMP below Inx's workspace-scoped
...
// terminal, even when Inx was launched from the Finder / Dock / open(1).
