...
const memoryCitationMessage = {
  kind: "message",
  memoryCitations: [{ kind: "memory_reference", source: "MEMORY.md", note: "inx workflow" }],
} as WireEvent;
...
const recoveryPaused = reducer(readinessStarted, {
  ...
  e: {
    ...
    err: "Automatic retries paused. Inx stopped repeated attempts and kept completed work. Send \"continue\" to start a fresh attempt, or add instructions to change direction.",
  } as WireEvent,
});
...
eq(
  ...
  "Inx stopped repeated attempts and kept completed work. Send “Continue” to start a fresh attempt, or add instructions to change direction.",
