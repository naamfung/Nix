// Command inx-desktop is the Wails shell around the Inx kernel: a native
...
// a nested module (inx/desktop) so the CGO/WebKit desktop build never touches
...
import (
	...
	// cmd/inx does — boot.Build resolves providers/tools from these registries.
...
// mirroring cmd/inx/main.go. The auto-updater reads it (App.Version) to compare
...
const (
	disableWebview2GPUEnv  = "INX_DESKTOP_DISABLE_WEBVIEW2_GPU"
