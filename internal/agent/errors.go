...
func (e *RecoveryPauseError) Error() string {
	...
	return "Automatic retries paused. Inx stopped repeated attempts and kept completed work. Send \"continue\" to start a fresh attempt, or add instructions to change direction."
}
