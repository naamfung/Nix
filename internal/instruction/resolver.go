...
var DocumentNames = []string{"INX.md", "AGENTS.md", "CLAUDE.md"}
var LocalDocumentNames = []string{"INX.local.md", "AGENTS.local.md", "CLAUDE.local.md"}
...
func userInstructionImportRoots(userDir string) []string {
	...
	if home, err := os.UserHomeDir(); err == nil && strings.TrimSpace(home) != "" {
		for _, name := range []string{".inx", ".agents", ".agent", ".claude"} {
