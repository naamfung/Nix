-- Unify dashboard auth onto id.inx.io: dashboard access is now a per-email
...
-- Apply: wrangler d1 execute inx-crash --remote --file=migrate-access.sql
...
-- admins/viewers keep their access when they next sign in via id.inx.io.
