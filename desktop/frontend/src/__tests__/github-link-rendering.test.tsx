...
eq(parseGitHubLink("https://github.com/naamfung/inx/issues/6856"), {
  kind: "issue",
  owner: "naamfung",
  repo: "inx",
  value: "6856",
...
eq(parseGitHubLink("https://github.com/naamfung/inx/pull/123?diff=split"), {
  kind: "pull",
  owner: "naamfung",
  repo: "inx",
  value: "123",
...
eq(parseGitHubLink("https://github.com/naamfung/inx/commit/abcdef1234567890"), {
  kind: "commit",
  owner: "naamfung",
  repo: "inx",
...
eq(parseGitHubLink("https://github.com/naamfung/inx"), null, "leaves repository links unchanged");
eq(parseGitHubLink("http://github.com/naamfung/inx/issues/1"), null, "rejects insecure GitHub links");
...
eq(classifyLinkIcon("https://github.com/naamfung/inx"), "github", "adds a GitHub icon to repository links");
...
{
  const href = "https://github.com/naamfung/inx/pull/6976";
  ...
  eq(
    ...
    "GitHub naamfung/inx pull request #6976",
...

{
  const link = renderLink(
    "https://github.com/naamfung/inx/issues/6856",
