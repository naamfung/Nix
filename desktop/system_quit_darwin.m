...
extern void InxMarkSystemQuit(void);
...
static NSApplicationTerminateReply inxApplicationShouldTerminate(id self, SEL _cmd, NSApplication *sender) {
    InxMarkSystemQuit();
...
static void inxWailsContextQuit(id self, SEL _cmd) {
    InxMarkSystemQuit();
...
void installInxSystemQuitHook(void) {
    ...
    if (method != NULL) {
        IMP replacement = (IMP)inxApplicationShouldTerminate;
    ...
    if (quitMethod != NULL) {
        IMP replacement = (IMP)inxWailsContextQuit;
