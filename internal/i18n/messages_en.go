...
var English = Messages{
	...
	SetKeyHint:      "Set your API key, then run `inx`.",
	ConfigLabel:     "config",
	ModelsLabel:     "models",
	...
	StepScaffold:    "scaffold inx.toml",
	...
	StepSetKeyHint: "run `inx setup`, or export DEEPSEEK_API_KEY=…",
	StepChatDesc:   "interactive session",
	StepRunDesc:    "one-shot task",
	HelpFooter:     "inx help · all commands",
	...
	OutputStyleHint:           "set agent.output_style in inx.toml to apply one (takes effect next session)",
	ThemeHeader:               "themes:",
	...
	MemoryNone:                "memory: none — add with “/remember <note>” or create INX.md in the project root",
	...
	MissingKeyIntro:          "inx.toml is ready — just an API key away.",
	...
	SkipStaleCustomEntryFmt:    "skipping stale %q entry from inx.toml (pointing at %s) — please remove it from [[providers]]",
...
Usage:
  ...
  inx task list|show --json [--dir PATH]           inspect redacted task state
