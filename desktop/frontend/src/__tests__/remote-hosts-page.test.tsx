...
const firstDialog = document.querySelector<HTMLElement>(".inx-confirm-dialog");
...
ok(removeCalls === 0 && document.querySelector(".inx-confirm-dialog") === null, "Cancel keeps the host and closes the dialog");
...
const secondDialog = document.querySelector<HTMLElement>(".inx-confirm-dialog");
await act(async () => {
